...
final List<Sight> mocks = [
  Sight(
    ...
    details: 'Музей расположен на бывшем полигоне железнодорожных войск недалеко от станции Безымянка, куда в годы Великой Отечественной войны прибывали поезда с эвакуированными предприятиями и гражданами из западных районов страны.',),
  Sight(
      ...
      details: 'Известный по всей стране еще с советских времен сорт светлого пива «Жигулевское» появился в Самаре, где действует Жигулевский пивоваренный завод. Сейчас это не просто успешное предприятие, но и весьма популярная достопримечательность. Многие люди, приезжающие в Самару, стараются заглянуть на пивоварню, чтобы отведать ее продукцию и взять с собой пару-тройку «сувениров» для друзей и родственников..',),
  Sight(
  ...
  Sight(
    ...
    details: 'В излучине Волги близ Усинского залива, выдающейся части Куйбышевского водохранилища, расположена эта уникальная по своей красоте местность — Самарская Лука. Неповторимый холмистый рельеф, блеск вод огибающей их красавицы Волги, мягкий, целебный микроклимат, богатство растительного и животного мира — все это издавна привлекало сюда туристов и просто отдыхающих.',),
  Sight(
  ...
  Sight(
    ...
    details: 'Загородный парк в Самаре, занимающий площадь более 42 га между набережной Волги и Ново-Садовой улицей, — самая большая садово-парковая территория в городе. Официальное название — Центральный парк культуры и отдыха им. Горького — используется крайне редко. Популярное место для проведения досуга открыто в будни с 11 до 18, в субботу и воскресенье — с 10 до 20, выходной — понедельник.',),
  Sight(
    ...
    details: 'Бункер Сталина — рассекреченное и ставшее в 1990 году музеем секретное бомбоубежище Иосифа Сталина. Данный объект расположен в здании бывшего обкома КПСС (сейчас — Самарского государственного университета культуры). Существование объекта держалось в секрете около 48 лет. Сегодня это самый «брендовый» объект города. Он не имеет статуса музея, этим объясняется сокращенный режим посещения.',),
  Sight(
